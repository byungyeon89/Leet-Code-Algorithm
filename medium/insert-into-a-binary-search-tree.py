...
def main():
    ...
    test_cases = [
        [[4,2,7,1,3], 5],																# 1
        [[40,20,60,10,30,50,70], 25],										# 2
        [[4,2,7,1,3,null,null,null,null,null,null], 5],	# 3       
        ]	

    for i, test in enumerate(test_cases):
        print("[%d]"% (i + 1))
        print("Input: root = ", test[0], ", val = ", test[1])
        print("Output:", s.partitionLabels(test[0], test[1]))
        print('\n')
